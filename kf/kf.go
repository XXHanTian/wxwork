...
type GetAccessTokenFunc func(ctx *KfApp) (accessToken string, err error)

// NoticeAccessTokenExpireFunc 通知中控 刷新 access_token
type NoticeAccessTokenExpireFunc func(ctx *KfApp) (err error)
...
创建应用实例
*/
func (corporation *Corporation) NewApp(config AppConfig) (app *KfApp) {
	instance := KfApp{
		Config: config,
		AccessToken: AccessToken{
...
*/
func (app *KfApp) SetAccessTokenCacheDriver(driver cachego.Cache) {
...
*/
func (app *KfApp) SetGetAccessTokenHandler(f GetAccessTokenFunc) {
...
*/
func (app *KfApp) SetNoticeAccessTokenExpireHandler(f NoticeAccessTokenExpireFunc) {
